...
public class LumpsConfigWeatherData
{
	...
	public LumpsConfigWeatherData(String runDirectory, int year, String runPrefix)
	{
		super();
...
//		boolean wholeHourFound = false;
		...
		st.append("%doy hr  Dectime     Qn      avU      avRH   Temp_C     avWD  pres_kpa     ph     avKdn  snow_pav  snow_blg  snow_con  snow_dec  snow_grass  Ldown   Fcld   Qf" + '\n');
...
//			String extWater = oneItem.get(PrestonWeatherData.EXT_WATER);	
			...
			String windDir = getHourlyAverageForItem(PrestonWeatherData.WIND_DIR, oneItem, dataForLastHalfHour);
			...
			String snowCon = "-999";
			String snowDec = "-999";
			String snowGrass = "-999";
			String cloudFrac = "-999";
...
//			}
	...
	{
		return FILENAME_PREFIX + runPrefix  + common.shortenYearTo2Digits(year) + "_X0001Y0001" + "_data" + FILENAME_SUFFUX;
	}
