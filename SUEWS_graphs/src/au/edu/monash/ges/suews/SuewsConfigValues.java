...
public class SuewsConfigValues
{
	...
	public void setDefaultValues()
	{
		...
		//ohm
		ohmConfigCanyonsIncluded = false;
		ohmConfigCalcuationsCoefficientsCanyons = 0;
		ohmConfigVegetationCalculated = 2;
		ohmConfigCalcuationsCoefficientsVegetation = new String[]{"3", "4", "0"};
		ohmConfigCalcuationsCoefficientsRoof= new String[]{"1"};
		ohmConfigImperviousAreasCalculated = 2;
		ohmConfigCalcuationsCoefficientsImperviousAreas= new String[]{"2", "4", "0"};
