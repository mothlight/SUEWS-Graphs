...
public class LumpsConfigGIS
{
	...
	public LumpsConfigGIS(String runDirectory, int year, String runPrefix)
	{
		super();
	...
	{		
		...
		st.append("id  it  qual   build     Paved   unman  con   dec     grass    " +
				//"IrrGrass  " +
				"water  cany3d  ROOF3D  " +
				//"z0m      zd     " +
				"planF   " +
...
//				getZd() +
	...
	{		
		return FILENAME_PREFIX + runPrefix + common.shortenYearTo2Digits(year) + "_" + "X0001Y0001" + FILENAME_SUFFUX;
	}
